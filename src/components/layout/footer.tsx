        ...
        <div className="container flex flex-col-reverse items-center justify-center gap-y-2 lg:flex-row">
          ...
          <div className="flex w-full flex-row items-center justify-center gap-4 lg:justify-end">
            <Button
              ...
              asChild
            >
              <Link target="_blank" href="https://github.com/mafiefa02">
                <GithubIcon size={24} />
              </Link>
            </Button>
            ...
            <Button
              ...
              asChild
            >
              <Link target="_blank" href="https://linkedin.com/in/mafiefa/">
            ...
            <Button
              ...
              asChild
            >
              <Link target="_blank" href="https://instagram.com/mafiefa/">
