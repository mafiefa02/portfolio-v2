      ...
      <TooltipProvider>
        <div className="flex w-full flex-wrap items-center gap-4">
          <Tooltip>
            <TooltipTrigger>
              <div className="flex h-16 w-16 cursor-pointer items-center justify-center overflow-clip rounded-[1rem] border border-primary bg-secondary transition-colors ease-out hover:bg-white">
                <Image src={figma} width={24} height={24} alt="figma" />
              </div>
            </TooltipTrigger>
            <TooltipContent>
              <p>Figma</p>
          ...
          <Tooltip>
            <TooltipTrigger>
              <div className="flex h-16 w-16 cursor-pointer items-center justify-center overflow-clip rounded-[1rem] border border-primary bg-secondary transition-colors ease-out hover:bg-white">
                <Image src={reactIcon} width={36} height={36} alt="react" />
              </div>
          ...
          <Tooltip>
            <TooltipTrigger>
              <div className="flex h-16 w-16 cursor-pointer items-center justify-center overflow-clip rounded-[1rem] border border-primary bg-secondary transition-colors ease-out hover:bg-white">
                <Image src={redisIcon} width={32} height={32} alt="redis" />
              </div>
            </TooltipTrigger>
          ...
          <Tooltip>
            <TooltipTrigger>
              <div className="flex h-16 w-16 cursor-pointer items-center justify-center overflow-clip rounded-[1rem] border border-primary bg-secondary transition-colors ease-out hover:bg-white">
                <Image src={goIcon} width={48} height={48} alt="go" />
              </div>
            </TooltipTrigger>
